								...
								<div style="overflow-x:auto;">								
									<table id="data-table" width="170px" class="table table-hover table-striped">
										...
										<?php
											...
											$query="SELECT a.tgl,a.login,b.user2,a.witel,a.fastel,a.nama_dm,a.tlp,a.penerima,a.reg,a.jenis,a.`status`,a.valid,a.rec_qco,a.kategori,a.reason,a.ket FROM
