			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form id='input' name="demoform" action='approve_recall.php' method='post' accept-charset='UTF-8'>
								...
								<div class="card ">
									<div class="header">
										<h4 class="title">APPROVAL ORDER RECALL TRANSAKSI</h4>
										</div>
								<div style="overflow-x:auto;">									
									<table id="data-table" width="150px" class="table table-hover table-striped">
										...
										$query="SELECT a.id,a.tgl,a.login,b.user2,a.witel,a.fastel,a.nama_dm,a.tlp,a.jenis,a.reason,a.ket,a.upd_qco,a.rec_qco,a.upd_tl,a.rec_tl,a.upd_qco,a.input ,a.upd_suport FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 $whr";
										//echo "$query";
										$no = 1;
