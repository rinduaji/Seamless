								...
								<div style="overflow-x:auto;">
									...
									<table id="data-table" class="table table-hover table-striped">
										...
										if (isset($_POST['search'])){
											...
											$query="SELECT a.tgl,a.login,b.user2,b.user5,a.fastel,a.nama_dm,a.tlp,a.penerima,a.witel,a.jenis,a.`status`,a.valid,a.kategori,a.reason,a.ket,a.input,a.upd_qco,a.rec_qco
											FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 
											WHERE b.user1 = a.login AND a.fastel like '$fastel' ";
