...
if (isset($_POST['Save'])) {
    ...
    $produk == "" OR $benefit == "" OR $respon == "" OR $kontrak == "" OR $closing == "" OR $mycx == "" OR $cp_verified == "") {
        clearstatcache();
        ...
        $produk == "Not Ok" OR $benefit == "Not Ok" OR $respon == "Not Ok" OR $kontrak == "Not Ok" OR $closing == "Not Ok" OR $script == "Not Ok" OR $kkontak == "Not Ok" 
		OR $dosir == "Not Ok" OR $kualifikasi == "Not Ok" OR $konfirmasi == "Not Ok" OR $mycx == "Not Ok" OR $cp_verified == "Not Ok") {
            ...
            $sql1 = "INSERT INTO `app_tam_data_trans` (tgl, login, witel, fastel, nama_dm, tlp, reg, jenis, status, kategori, reason, segment, relasi, 
                    ...
                    id_data2, prof_hp,script,kkontak,dosir,kualifikasi,konfirmasi,mycx,cp_verified) VALUES ('" . $data['tgl'] . "', '" . $data['login'] . "', '" . $data['witel'] . "', '" . $data['fastel'] . "', '" . $data['nama_dm'] . "', '"
                ...
                '$produk', '$benefit', '$respon', '$kontrak', '$closing', '$ids', '$pn','$script','$kkontak','$dosir','$kualifikasi','$konfirmasi','$mycx','$cp_verified')";
        ...
        else if ($greating == "Reject" OR $confirm == "Reject" OR $apresiasi == "Reject" OR $experience == "Reject" OR $identifikasi == "Reject" OR $penawaran == "Reject" OR 
            $produk == "Reject" OR $benefit == "Reject" OR $respon == "Reject" OR $kontrak == "Reject" OR $closing == "Reject" OR $script == "Reject" OR $kkontak == "Reject" 
            OR $dosir == "Reject" OR $kualifikasi == "Reject" OR $konfirmasi == "Reject" OR $mycx == "Reject" OR $cp_verified == "Reject") {
                $sql = "UPDATE `app_tam_data2` SET follow = '5' , `rec_qco`='$rec_qco', upd_qco='$login' , tgl_qco1='$tgl' , valid='Reject', prof_hp='$pn' WHERE `id`='$ids'";
                $query = mysqli_query($con, $sql);
                $sql1 = "INSERT INTO `app_tam_data_trans` (tgl, login, witel, fastel, nama_dm, tlp, reg, jenis, status, kategori, reason, segment, relasi, 
                        penerima, ket, follow, upd_qco, rec_qco, upd_tl, rec_tl, upd_suport, rec_suport, tgl_qco1, tgl_tl,tgl_suport, valid, input, prof_agama, 
                        prof_facebook, add_on_tsel, greating, confirm, apresiasi, experience, identifikasi, penawaran, produk, benefit, respon, kontrak, closing, 
                        ...
                        <div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="ket" style="width: 50%" ><?php echo $data['ket']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Rekomendasi QCO</label>
                                    <textarea class="form-control" name="rec_qco" style="width: 50%" ></textarea>
                                </div>
                            </div>
							 <div class="row">
                                <div class="col-md-12">
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Plg yg ditawarkan tdk sesuai dgn kualifikasi utk Produk Wifi Extender & Pijar Belajar?</label>
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Agent tidak konfirmasi 6A & 6B?</label>
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Agent tidak input MYCX?</label>
                                        <select class="form-control" name="mycx" style="width: 25%">
                                            <option value="">--- Pilihan ---</option>
                                            <option value="Ok">Ok</option>
                                            <option value="Not Ok">Not Ok</option>
											 <option value="Reject">Reject</option>
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">CP tidak ditemukan di menu contact verified?</label>
                                        <select class="form-control" name="cp_verified" style="width: 25%">
                                            <option value="">--- Pilihan ---</option>
                                            <option value="Ok">Ok</option>
                                            <option value="Not Ok">Not Ok</option>
											 <option value="Reject">Reject</option>
