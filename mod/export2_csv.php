...
a.greating AS Greating,
a.confirm AS Konfirmasi,
a.apresiasi AS Apresiasi,
a.experience AS Experience_Pelanggan,
a.identifikasi AS Identifikasi_Kebutuhan,
a.penawaran AS Penawaran,
a.produk AS Keunggulan_Produk,
a.benefit AS Benefit,
a.respon AS Beri_Plg_Respon,
a.kontrak AS Kontrak,
a.closing AS Closing,
a.script AS Script,
a.kkontak AS Kkontak,
a.dosir AS Dossier,
a.kualifikasi AS Kualifikasi,
a.konfirmasi AS Konfirmasi,
a.mycx AS MYCX,
a.cp_verified AS CP_VERIFIED
FROM
...
// filename for export
$csv_filename = 'Data Seamless'.date('Y-m-d').' '.$site.'.csv';
