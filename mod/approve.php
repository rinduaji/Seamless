...
$query="SELECT a.id,a.tgl,a.login,b.user2,a.witel, a.fastel,a.tlp,a.jenis,a.upd_qco,a.rec_qco,a.upd_tl,a.rec_tl,a.upd_qco,a.input ,a.upd_suport FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 $whr ";
//echo $query;
}else{
	$query="SELECT a.id,a.tgl,a.login,b.user2,a.witel,a.fastel,a.tlp,a.jenis,a.upd_qco,a.rec_qco,a.upd_tl,a.rec_tl,a.upd_qco,a.input ,a.upd_suport FROM app_tam_data2 AS a INNER JOIN cc147_main_users_extended AS b ON a.login = b.user1 $whr ";
//echo $query;
							...
							<div class="card ">
								...
								<div style="overflow-x:auto;">
									<table class="table table-hover table-striped">
										...
										else if ($jb=="Tabber" && $data['upd_qco']=="$uname"){echo "<th align=\"center\"><a href=\"form_tabber2.php?id=$data[id]\">My Approve</a></th>";}
